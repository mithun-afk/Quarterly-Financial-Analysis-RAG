...
- **Upload & Indexing:** `[Insert link to screenshot here]`
- **Answer with Citations:** `[Insert link to screenshot here]`
- **Trap Question Refusal:** `[Insert link to screenshot here]`
- **3-Minute Demo Video:** `[Insert link to YouTube/Loom video here]`